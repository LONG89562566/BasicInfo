...
import com.info.admin.result.Data;
import com.info.admin.result.JsonResult;
import com.info.admin.result.JsonResultCode;
import com.info.admin.result.LayuiResult;
import com.info.admin.result.LayuiResultCode;
...
public class UploadController extends BaseController {
	...
	public JsonResult uploadImgs(HttpServletRequest request, HttpServletResponse response, MultipartFile[] logoImgFile) {
		try {
			if (logoImgFile != null) {
				List<String> logoPathList = MultipartFileUtils.getImgPath(request, response, logoImgFile);
				if (CollectionUtils.isNotEmpty(logoPathList)) {
					// 返回图片的路径
					return new JsonResult(JsonResultCode.SUCCESS, "上传成功", logoPathList);
				}else {
