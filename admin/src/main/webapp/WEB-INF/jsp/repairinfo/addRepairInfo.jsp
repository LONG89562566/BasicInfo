 		...
 		<form id="saleForm" class="layui-form" style="margin-top:30px;">
			...
			<div class='layui-form-item'>
     			<div class="layui-inline">
	            	...
	            	<div class="layui-input-inline">
		            	<input onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"  name="createTime" id="createTime" value="${repairInfo.createTimeStr}" class="form-control input-small" placeholder="请选择创建时间"/>
     			...
     			<div class="layui-inline">
		        	...
		        	<div class="layui-input-inline">
		        		<input type="text" id="createUser" name="createUser" placeholder="请输入创建人编号"  value="${repairInfo.createUser }" class="layui-input"/>
			...
			<div class='layui-form-item'>
     			<div class="layui-inline">
		        	...
		        	<div class="layui-input-inline">
		        		<input type="text" id="deleteFlag" name="deleteFlag" placeholder="请输入删除标记"  value="${repairInfo.deleteFlag }" class="layui-input"/>
     			...
     			<div class="layui-inline">
	            	...
	            	<div class="layui-input-inline">
		            	<input onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"  name="updateTime" id="updateTime" value="${repairInfo.updateTimeStr}" class="form-control input-small" placeholder="请选择修改时间"/>
			...
			<div class='layui-form-item'>
     			<div class="layui-inline">
		        	...
		        	<div class="layui-input-inline">
		        		<input type="text" id="seq" name="seq" placeholder="请输入排序号"  value="${repairInfo.seq }" class="layui-input"/>
		        		<span style="color: red" id="s-seq"></span>
		     		</div>
     			</div>
     			<div class="layui-inline">
		        	<label class="layui-form-label">维修人员编号</label>
		        	<div class="layui-input-inline">
		        		<input type="text" id="repairUser" name="repairUser" placeholder="请输入维修人员编号"  value="${repairInfo.repairUser }" class="layui-input"/>
