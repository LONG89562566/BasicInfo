 		...
 		<form id="saleForm" class="layui-form" style="margin-top:30px;">
			...
			<div class='layui-form-item'>
     			<div class="layui-inline">
	            	...
	            	<div class="layui-input-inline">
		            	<input onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"  name="createTime" id="createTime" value="${proportions.createTimeStr}" class="form-control input-small" placeholder="请选择创建时间"/>
     			...
     			<div class="layui-inline">
		        	...
		        	<div class="layui-input-inline">
		        		<input type="text" id="createUser" name="createUser" placeholder="请输入创建人编号"  value="${proportions.createUser }" class="layui-input"/>
			...
			<div class='layui-form-item'>
     			<div class="layui-inline">
		        	...
		        	<div class="layui-input-inline">
		        		<input type="text" id="deleteFlag" name="deleteFlag" placeholder="请输入删除标记"  value="${proportions.deleteFlag }" class="layui-input"/>
     			...
     			<div class="layui-inline">
	            	...
	            	<div class="layui-input-inline">
		            	<input onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"  name="updateTime" id="updateTime" value="${proportions.updateTimeStr}" class="form-control input-small" placeholder="请选择修改时间"/>
			...
			<div class='layui-form-item'>
     			...
     			<div class="layui-inline">
		        	...
		        	<div class="layui-input-inline">
		        		<input type="text" id="projectId" name="projectId" placeholder="请输入项目编号"  value="${proportions.projectId }" class="layui-input"/>
