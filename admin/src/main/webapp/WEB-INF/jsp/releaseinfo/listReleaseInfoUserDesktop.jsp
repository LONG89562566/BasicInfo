...
<script type="text/javascript">
    ...
    //查询数据Url
    var pageQueryUrl = "<%=request.getContextPath()%>/admin/releaseInfo/pageQueryUser";
    //查询条件表单Id
...
<script>
    ...
    var setAddOrEdit = function(releaseId){
        ...
        layer.open({
            ...
            content: '<%=request.getContextPath()%>/admin/releaseInfo/addOrEditUser?releaseId='+releaseId,
