...
<html>
			             ...
			             <table id="example1" class="table table-bordered table-striped">
			               <thead>
				              <tr>
			                    ...
			                    <th field="materialType"  >出入库</th>
			                    <th field="repertoryId"  >虚拟仓库物品ID</th>
			                    <th field="num"  >出入库数量</th>
			               ...
			               <c:forEach items="${paginator.object}" var="r" varStatus="st"> 
						        ...
						        <td>
						         <div class="site-demo-button" >
								   <button id="updateMaterialDetail" data-method="setAddOrEdit" value="${r.materialDetailId}" class="layui-btn layui-btn-normal layui-btn-small"><i class="layui-icon"></i><span>&nbsp;&nbsp;修改</span></button>
								 </div>
						       </td>
				             </tr>
						   </c:forEach>
	...
	<script>
		...
		//新增、编辑打开
		var setAddOrEdit = function(materialDetailId){
		     //多窗口模式，层叠置顶
		     layer.open({
		         type: 2, 
		         title: '新增/修改 材料出入库',
		         ...
		         content: '<%=request.getContextPath()%>/admin/materialDetail/addOrEdit?materialDetailId='+materialDetailId,
