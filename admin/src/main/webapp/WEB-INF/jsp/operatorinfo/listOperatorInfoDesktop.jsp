...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini">
	  ...
	  <div class="content-wrapper">
	    ...
	    <!-- Main content -->
	    <shiro:hasPermission name="operatorInfo:query">
		        ...
		        <div class="col-xs-12">
		          <div class="box">
			        ...
			        <div class="box box-info">
			           <!-- form start -->
			           <form  id="form_submit" class="form-horizontal" action="/admin/operatorInfo/list" method="post">
			             ...
			             <table id="example1" class="table table-bordered table-striped">
			               <thead>
				              <tr>
			                    ...
			                    <th field="seq"  >排序号</th>
			                    <th field="goodsId"  >设备/工装编号</th>
			                    <th field="operator"  >人员编号</th>
			               ...
			               <c:forEach items="${paginator.object}" var="r" varStatus="st"> 
						        ...
						        <td>
						         <div class="site-demo-button" >
								   <button id="updateOperatorInfo" data-method="setAddOrEdit" value="${r.supplierId}" class="layui-btn layui-btn-normal layui-btn-small"><i class="layui-icon"></i><span>&nbsp;&nbsp;修改</span></button>
								 </div>
						       </td>
				             </tr>
						   </c:forEach>
	...
	<script type="text/javascript">
		...
		//查询数据Url
		var pageQueryUrl = "<%=request.getContextPath()%>/admin/operatorInfo/pageQuery";
		//查询条件表单Id
	...
	<script>
			...
			var active = {
				...
				offset: function(othis){
					...
					if(status.indexOf("禁用")!=-1){
						//禁用的url
						requestUrl="<%=request.getContextPath()%>/admin/operatorInfo/disabled";
						text = "确定要禁用此条数据吗？";
					}else{
						//启用的url
						requestUrl="<%=request.getContextPath()%>/admin/operatorInfo/enabled";
						text = "确定要启用此条数据吗？";
					}
					var id = othis.val();
		...
		var setAddOrEdit = function(supplierId){
		     ...
		     layer.open({
		         ...
		         content: '<%=request.getContextPath()%>/admin/operatorInfo/addOrEdit?supplierId='+supplierId,
