...
<html>
			           ...
			           <div class="box-body">
			             ...
			             <table id="example1" class="table table-bordered table-striped">
			               ...
			               <c:forEach items="${paginator.object}" var="r" varStatus="st"> 
						        ...
						        <td>
						         <div class="site-demo-button" >
								   <button id="updateProblem library" data-method="setAddOrEdit" value="${r.supplierId}" class="layui-btn layui-btn-normal layui-btn-small"><i class="layui-icon"></i><span>&nbsp;&nbsp;修改</span></button>
								 </div>
						       </td>
				             </tr>
						   </c:forEach>
	...
	<script type="text/javascript">
		...
		//查询数据Url
		var pageQueryUrl = "<%=request.getContextPath()%>/admin/problem library/pageQuery";
		//查询条件表单Id
	...
	<script>
		...
		var setAddOrEdit = function(supplierId){
		     ...
		     layer.open({
		         ...
		         content: '<%=request.getContextPath()%>/admin/problem library/addOrEdit?supplierId='+supplierId,
