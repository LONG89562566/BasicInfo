...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>工装报表${sessionScope.login_session_admin.userName}</h1>
    </section>
    <!-- Main content -->
        ...
        <section class="content">
            ...
            <div class="row">
                <div style="float: left;width: 18%;height: 500px;background-color: white;margin-right: 1%">
                    <table id="frockInfoRepertoryTree" title="所有条件" style="width:100%;height:500px">
                        <thead>
                        <tr>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th field="type" id="type" >类别</th>
                                    <th field="mId" id="m_id" >管理编号</th>
                                    <th field="name" id="name" >名称</th>
                                    <th field="model" id="model" >型号规格</th>
                                    <th field="manufacturer" id="manufacturer"  >生产厂家</th>
                                    <th field="state" id="state" >完好状态</th>
                                    <th field="usePlace" id="use_place" >使用场所</th>
                                    <th field="liabler" id="liabler" >责任人</th>
                                    <th field="purchaseTime" id="purchase_time" type='date'>购置日期</th>
...
<script type="text/javascript">
    //查询数据Url
    var pageQueryUrl = "<%=request.getContextPath()%>/admin/reportForm/frockInfoPageQuery";
    //查询条件表单Id
...
<script type="text/javascript" charset="utf-8">
    ...
    var asynLoadTree = "<%=request.getContextPath()%>/admin/reportForm/frockInfoRepertoryTree";

    $(document).ready(function () {
        frockInfoRepertoryTree();
    });

    $("#projectId").bind("change",function(){
        initPaginator();
    });
    var frockInfoRepertoryTree = function () {
        //加载菜单
        $('#frockInfoRepertoryTree').treegrid({
            url:asynLoadTree,
            multiple : true,
            method: 'get',          //请求方式
            ...
            onClickRow: function (row) {
                $('#frockInfoRepertoryTree').treegrid('select');
                $('#pageNum').val(1);
                //点击时初始化数据
